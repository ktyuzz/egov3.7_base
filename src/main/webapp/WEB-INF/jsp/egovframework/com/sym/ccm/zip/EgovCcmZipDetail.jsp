...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <c:if test="${searchList == '2'}">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="<spring:message code="comSymCcmZip.zipVO.altImg"/>">&nbsp;<spring:message code="comSymCcmZip.zipVO.rdmn" /> <spring:message code="title.detail" /></h1></td>
  </c:if>
 </tr>
</table>
