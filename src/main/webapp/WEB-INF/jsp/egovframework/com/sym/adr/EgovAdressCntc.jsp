...
<link href="<c:url value='/css/egovframework/com/com12.css' />" rel="stylesheet" type="text/css">
...
<form name="form" id="form" method="post">
 <table width="700" cellpadding="8" class="table-search" border="0">
   ...
   <tr>
     ...
     <th>승인키</th>
     <td><input type="text" name="confmKey" id="confmKey" style="width:250px;" value="bnVsbDIwMTQxMDAxMTQwNDA1"/></td>
   </tr>
 </table>
 <table>   
   <tr>
