...
<h1><spring:message code="comSymCcmZip.zipVO.SearchRdmn" /> <spring:message code="title.list" /></h1>
</c:if>
	...
	<div class="search_box">
		<ul>
			<li>
			   ...
			   <option value='2' <c:if test="${searchVO.searchList == '2'}">selected="selected"</c:if>><spring:message code="comSymCcmZip.zipVO.SearchRdmn" /></option> <!-- 도로명주소 -->
			   <c:out value="${searchVO.searchList }" />
		    </select>
		    </li>
			<li>
