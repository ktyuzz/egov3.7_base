...
<!-- <input name="managtCn" type="hidden" value="Testing..."> -->
	...
	<tbody >
		...
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left">
  				<form:input type="text" path="qestnrTmplatCours" size="73" cssClass="txaIpt" maxlength="100" title="<spring:message code='comUssOlpQtm.regist.qestnrTmplatCours'/><spring:message code='input.input'/>"/><!-- title="템플릿파일(경로) 입력" -->
