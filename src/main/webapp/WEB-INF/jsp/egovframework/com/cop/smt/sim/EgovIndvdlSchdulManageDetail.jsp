...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="formList" action="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageList.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
			<input type="submit" class="s_submit" value="<spring:message code="button.list" />" title="<spring:message code="button.list" /> <spring:message code="input.button" />" onClick="fn_egov_list_IndvdlSchdulManage(); return false;">
		</form>
