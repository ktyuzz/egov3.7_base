...
<!-- 검색영역 -->
<form:form name="listForm" action="${pageContext.request.contextPath}/cop/adb/selectAdbkList.do" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/cop/adb/addAdbkInf.do'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onClick="javascript:fn_egov_addadbkInf();return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
