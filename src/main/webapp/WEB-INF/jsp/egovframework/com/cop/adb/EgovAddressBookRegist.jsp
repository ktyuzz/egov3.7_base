...
<div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			...
			<td class="nopd">
				<input name="adbkNm" size="73" maxlength="255" value='<c:out value="${searchVO.adbkNm}" />'/>
			</td>
		</tr>
		<!--공개범위 -->
		...
		<tr>
			...
			<td class="left">
			   ...
			   <a href="#" onClick="fn_egov_inqire_user();return false;"><img src="<c:url value='/images/egovframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt=<spring:message code="comCopSmtDsm.registBtn.schdulCn"/> title="<spring:message code="comCopSmtDsm.registBtn.schdulCn"/>"></a>
			</td>
		</tr>
