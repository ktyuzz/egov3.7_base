...
<div class="board">
	...
	<tr>
		...
		<td><c:out value='${resultInfo.userId}'/></a></td>
		...
		<c:choose>
			...
			<!-- 회원가입 신청상태일 경우 -->
				<td>
					<a href="<c:url value='/cop/cmy/insertCommuUser.do?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">가입승인</a>&nbsp;	
					<a href="<c:url value='/cop/cmy/deleteCommuUser.do?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">가입거절</a>	
				</td>		
			</c:when>
			...
			<!-- 일반회원 상태일 경우 -->
				<td>
					<a href="<c:url value='/cop/cmy/insertCommuUserAdmin.do?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">관리자등록</a>&nbsp;	
					<a href="<c:url value='/cop/cmy/deleteCommuUser.do?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">탈퇴</a>	
				</td>		
			</c:when>
			...
			<!-- 관리자일 경우 -->
				<td>
					<a href="<c:url value='/cop/cmy/deleteCommuUserAdmin.do?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">관리자해제</a>
				</td>		
			</c:when>
