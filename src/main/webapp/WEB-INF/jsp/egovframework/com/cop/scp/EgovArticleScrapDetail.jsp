...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="formDelete" action="<c:url value='/cop/scp/deleteArticleScrap.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
			<input type="submit" class="s_submit" value="<spring:message code="button.delete" />" title="<spring:message code="button.delete" /> <spring:message code="input.button" />" onclick="fn_egov_delete_articleScrap(this.form); return false;">
			<input name="scrapId" type="hidden" value="${result.scrapId}">
		</form>
