...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="formDelete" action="<c:url value='/cop/smt/dsm/EgovDiaryManageDetail.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
			<input type="submit" class="s_submit" value="<spring:message code="button.delete" />" title="<spring:message code="button.delete" /> <spring:message code="input.button" />" onclick="fn_egov_delete_DiaryManage(this.form); return false;">
			<input name="diaryId" type="hidden" value="${diaryManageVO.diaryId}">
