	...
	<form:form commandName="articleScrapVO" action="${pageContext.request.contextPath}/cop/scp/updateArticleScrap.do" method="post"	onSubmit="fn_egov_updt_articleScrap(document.forms[0]); return false;">
		<div class="wTableFrm">
			...
			<div class="btn">
				...
				<span class="btn_s"><a href="<c:url value='/cop/scp/selectArticleScrapList.do' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span></div>
